...
//20110208ysk end
		...
		case 'acting_remise_card':
			...
			$html .= '<form id="purchase_form" name="purchase_form" action="' . $send_url . '" method="post" onKeyDown="if (event.keyCode == 13) {return false;}" onSubmit="return wait_just_moment()" accept-charset="Shift_JIS">
