...
//20101018ysk end
	...
	$('#mitumoriprint').click(function() {
		$('#new_pdf').html('<iframe src="<?php echo WP_ADMIN.'?page=usces_orderlist&order_action=pdfout&order_id='.$order_id; ?>&type=mitumori" align="center" width="660" height=670" border="1" marginheight="0" marginwidth="0"></iframe>');
	...
	$('#nohinprint').click(function() {
		$('#new_pdf').html('<iframe src="<?php echo WP_ADMIN.'?page=usces_orderlist&order_action=pdfout&order_id='.$order_id; ?>&type=nohin" align="center" width="660" height=670" border="1" marginheight="0" marginwidth="0"></iframe>');
	...
	$('#receiptprint').click(function() {
		$('#new_pdf').html('<iframe src="<?php echo WP_ADMIN.'?page=usces_orderlist&order_action=pdfout&order_id='.$order_id; ?>&type=receipt" align="center" width="660" height=670" border="1" marginheight="0" marginwidth="0"></iframe>');
		$('#PDFDialog').dialog('option', 'title', '<?php _e('Print Receipt', 'usces'); ?>');
		$('#PDFDialog').dialog('open');
		uscesMail.ordercheckpost('receiptprint');
	});
	$('#billprint').click(function() {
		$('#new_pdf').html('<iframe src="<?php echo WP_ADMIN.'?page=usces_orderlist&order_action=pdfout&order_id='.$order_id; ?>&type=bill" align="center" width="660" height=670" border="1" marginheight="0" marginwidth="0"></iframe>');
