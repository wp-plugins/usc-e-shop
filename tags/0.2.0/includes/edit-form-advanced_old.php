...
/**
 * Display post submit form fields.【公開】side core
 *
 * @since 2.7.0
 *
 * @param object $post
...
<a class="preview button" href="<?php echo $preview_link; ?>" target="wp-preview" id="" tabindex="4"><?php _e('Preview'); ?></a>
...
<?php
if ( ( 'editcomentout' == $action ) && current_user_can('delete_post', $post->ID) ) { ?>
<a class="submitdelete deletion" href="<?php echo wp_nonce_url("admin.php?page=usces_itemedit&action=delete&amp;post=$post->ID", 'delete-post_' . $post->ID); ?>" onclick="if ( confirm('<?php echo js_escape(sprintf( ('draft' == $post->post_status) ? __("You are about to delete this draft '%s'\n  'Cancel' to stop, 'OK' to delete.") : __("You are about to delete this post '%s'\n  'Cancel' to stop, 'OK' to delete."), $post->post_title )); ?>') ) {return true;}return false;"><?php _e('Delete'); ?></a>
<?php } ?>
</div>
...
/**
 * Display post tags form fields.【タグ】side core
 *
 * @since 2.6.0
 *
 * @param object $post
...
<!--	<p id="jaxtag">
	...
	<p id="tagcloud-link" class="hide-if-no-js">
		<a href='#'><?php //_e( 'Choose from the most popular tags' ); ?></a>
	</p>
--><?php
//}
...
?>
<ul id="category-tabs">
	<li class="ui-tabs-selected"><a href="#categories-all" tabindex="3">商品の階層カテゴリー</a></li>
...
<div id="categories-all" class="ui-tabs-panel">
	<ul id="categorychecklist" class="list:category categorychecklist form-no-clear">
		<?php wp_category_checklist($post->ID, USCES_ITEM_CAT_PARENT_ID, false, $popular_ids) ?>
	</ul>
</div>
