...
function usces_paypal_delivery_method( $delivery_method_select, $delivery_date, $delivery_time ) {
	global $usces;
usces_log("delivery_date=".$delivery_date,"paypal.log");
usces_log("delivery_time=".$delivery_time,"paypal.log");
...
function usces_paypal_use_point( $usepoint, $total_price, $item_price ) {
	...
	$member = $usces->get_member();
	$usces_entries = $usces->cart->get_entry();
usces_log(print_r($member,true),"paypal.log");
usces_log(print_r($usces_entries,true),"paypal.log");
...
usces_log(print_r($entry,true),"paypal.log");
