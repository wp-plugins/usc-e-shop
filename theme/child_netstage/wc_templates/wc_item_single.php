...
<?php endif; ?>
	...
	<span class="item_caution_title">はじめにお読みください！</span>
	<ul>
		<li>当サイトにて商品を購入される際には、送料、利用規約等を必ずお読みの上ご注文いただけますようお願いいたします。</li>
		<li>ご注文いただきますと注文確認のメールが送られてきます。合計金額についてはメールでの金額が最終確定金額となりますのでご確認ください。</li>
		<li>メールが届かない場合、ご登録のメールアドレスに誤りがある場合がございます。ご注文、お問い合わせ等していただいてから5営業日経過後も当社より返信がない場合、お手数ではございますが再度ご登録メールアドレスのご確認をいただくか、当社までお問い合わせください。</li>
	</ul>
	</div>
